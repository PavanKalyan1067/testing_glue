...
#derived_fields_df.select("alarmid","closedat","closedat_date","closedat_time","closedat_day","closedat_month","closedat_year","closedat_hour","closedat_minute","closedat_second","closedat_week","closedat_quarter").show(10, truncate = False)
